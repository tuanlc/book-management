...
var file_github_com_tuanlc_book_management_pkg_grpc_book_book_proto_rawDesc = []byte{
	...
	0x6f, 0x6f, 0x6b, 0x32, 0xc2, 0x01, 0x0a, 0x0b, 0x42, 0x6f, 0x6f, 0x6b, 0x53, 0x65, 0x72, 0x76,
...
var file_github_com_tuanlc_book_management_pkg_grpc_book_book_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
...
var file_github_com_tuanlc_book_management_pkg_grpc_book_book_proto_depIdxs = []int32{
	...
	1, // 5: book.BookService.getBook:input_type -> book.GetBookRequest
	4, // 6: book.BookService.listBooks:input_type -> book.ListBookRequest
	6, // 7: book.BookService.createBook:input_type -> book.CreateBookRequest
	3, // 8: book.BookService.getBook:output_type -> book.GetBookResponse
	5, // 9: book.BookService.listBooks:output_type -> book.ListBookResponse
	7, // 10: book.BookService.createBook:output_type -> book.CreateBookResponse
